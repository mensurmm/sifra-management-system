...
<div class="space-y-6">
    <div class="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-slate-900">Borrowing Details</h1>
            <p class="mt-1 text-sm text-slate-600">Add the borrowing details experience for this module.</p>
        </div>
